...
jQuery(window).load(function(){
	...
	jQuery('.slide1 .top_slider_cap').each(function() {
		var cap_title_w = $(this).find('h1').width() + 2;
		$(this).css('width', cap_title_w);
		
		var title_w = $(this).find('p').width();
		var title_w_half = $(this).find('p').width()/2;
		
		$(this).find('.left_line_title').css('margin-right', title_w_half + 20);
		$(this).find('.right_line_title').css('margin-left', title_w_half + 20);
		
	});
	
	jQuery('.slide2 .top_slider_cap').each(function() {
		var cap_title_w = $(this).find('h1').width() + 2;
		$(this).css('width', cap_title_w);
